...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2026 at 12:41 PM
...
ALTER TABLE `order_assignments`
  ...
  ADD CONSTRAINT `order_assignments_ibfk_2` FOREIGN KEY (`delivery_boy_id`) REFERENCES `delivery_boys` (`id`) ON DELETE CASCADE;
COMMIT;
